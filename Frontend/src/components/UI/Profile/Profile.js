...
const Profile = (props) => {
    ...
    const updateItems = async() =>{
         await axios.get(`https://generrete-backend.onrender.com/resume/history/${user.email}`)
        .then((response) => {
      ...
      await axios.get(`https://generrete-backend.onrender.com/offer_letter/history/${user.email}`)
        .then((response) => {
